...
$GithubRepositoryName = "moritzschachinger/20251105_HTLVBFingerflitzer"
...
# TODO
# App registration mit az cli
# * Reply url, Secret
# * Infos anzeigen (ClientId, TenantId, Instance, ResponseType)
# * Client secret mit dotnet cli setzen
# * Client secret in Azure web app config setzen
# ============================
...
$servicePrincipalSecret = az ad sp create-for-rbac `
  --name "gh-action-to-deploy-fingerflitzer-webapp-schm" `
  --role contributor `
